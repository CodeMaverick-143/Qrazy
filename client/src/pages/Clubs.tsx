        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 gap-6">
                <div>
                    <div className="inline-flex items-center gap-2 px-3 py-1 mb-4 border border-neon-slime/20 bg-neon-slime/5">
                        ...
                        <span className="text-neon-slime font-mono text-[10px] uppercase tracking-widest">Protocol Discovery Active</span>
                    </div>
            ...
            {loading ? (
                <div className="flex flex-col items-center justify-center py-32 gap-6">
                    ...
                    <span className="font-mono text-xs text-brand-gray/40 uppercase tracking-[0.4em] animate-pulse">Syncing Reality...</span>
                </div>
                ...
                <div className="text-center py-32 border border-dashed border-white/10 bg-white/5">
                    <p className="text-brand-gray/40 font-mono uppercase tracking-[0.3em] text-sm mb-4">No signals detected in this sector.</p>
                    <button
