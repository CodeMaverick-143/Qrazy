        ...
        <div className="space-y-6 max-w-xs mx-auto">
          <div className="flex flex-col items-center gap-4 py-8 glass-panel border-white/5">
            ...
            <div className="space-y-2">
              <p className="font-mono text-[10px] text-white uppercase tracking-[0.3em] font-black">
                Establishing Secure Link
              </p>
              <p className="font-mono text-[9px] text-brand-gray/40 uppercase tracking-widest px-8">
                Validating cryptographically signed token with central QRAZY protocol...
              </p>
            </div>
          </div>
