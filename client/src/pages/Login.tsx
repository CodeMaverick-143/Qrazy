...
import { ShieldCheck, GoogleLogo, EnvelopeSimple, SpinnerGap, ArrowRight, Fingerprint } from '@phosphor-icons/react';
                ...
                <div className="glass-panel border-white/5 relative overflow-hidden group">
                        ...
                        {activeTab === 'signup' && (
                            <div className="mb-8 p-4 bg-hot-pink/5 border border-hot-pink/20">
                                <p className="font-mono text-[9px] text-hot-pink uppercase tracking-wider leading-relaxed">
                                    Welcome, recruit. Enter your email protocol below. We will establish your credentials upon first entry. No password required.
                                </p>
                            </div>
                        )}
                        ...
                        <div className="space-y-6">
                            ...
                            >
                                <div className="flex items-center gap-4">
                                    ...
                                    <span className="font-display font-black text-void-black uppercase tracking-tight">Identity via Google</span>
                                </div>
                                <ArrowRight size={20} className="text-void-black transition-transform group-hover/auth:translate-x-1" />
                            </button>
                            ...
                            <form onSubmit={handleMagicLink} className="space-y-4">
                                <div className="space-y-2">
                                    <label className="flex items-center justify-between px-1">
                                        <span className="font-mono text-[10px] text-brand-gray/40 uppercase tracking-widest">Email Vector</span>
                    ...
                    <div className="p-6 bg-white/5 border-t border-white/5 flex items-center justify-between">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="font-mono text-[9px] text-brand-gray/40 uppercase tracking-widest">SSL Secured Link</span>
                        </div>
                        <span className="font-mono text-[9px] text-brand-gray/20 uppercase">No Data Shared with Third Parties</span>
                    </div>
                </div>
