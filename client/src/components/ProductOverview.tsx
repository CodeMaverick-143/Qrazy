    ...
    <section className="py-24 bg-corp-bg relative z-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-sm font-bold tracking-widest text-trust-blue uppercase mb-3">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {features.map((feature, index) => (
            <div
              key={index}
              className="group p-8 rounded-2xl bg-corp-bg-lighter border border-white/5 hover:border-trust-blue/30 transition-all duration-300 hover:shadow-lg hover:-translate-y-1"
            >
              ...
              <a
                href={feature.link}
                className="inline-flex items-center text-trust-blue font-semibold text-sm hover:text-blue-400 transition-colors"
              >
