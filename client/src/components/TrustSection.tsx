      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-wrap justify-center items-center gap-12 md:gap-20 opacity-40 grayscale hover:grayscale-0 transition-all duration-500">
          ...
          <SlackLogo
            size={32}
            weight="fill"
            className="text-white hover:text-[#4A154B] transition-colors"
          />
          <SpotifyLogo
            size={32}
            weight="fill"
          ...
          <StripeLogo
            size={32}
            weight="fill"
            className="text-white hover:text-[#635BFF] transition-colors"
          />
          <TwitchLogo
            size={32}
            weight="fill"
            className="text-white hover:text-[#9146FF] transition-colors"
          />
        </div>
      </div>
    </section>
