    ...
    return (
        <div className="relative">
            ...
            >
                ...
                <span className="font-mono text-xs text-white uppercase tracking-widest">{selectedCity}</span>
                ...
                <div className="absolute top-full left-0 mt-2 w-48 bg-void-black border border-white/10 z-50 shadow-2xl backdrop-blur-xl bg-opacity-95">
                    {CITIES.map((city) => (
                        <button
                            ...
                            className={`w-full text-left px-4 py-3 font-mono text-xs uppercase tracking-widest transition-colors hover:bg-neon-slime hover:text-void-black ${selectedCity === city ? 'text-neon-slime' : 'text-brand-gray/60'
                                }`}
                        >
                            {city}
                        </button>
