...
import { List, X, Lightning, Ticket, House, Martini } from '@phosphor-icons/react';
...
export default function Navbar() {
    ...
    const navLinks = [
        ...
        { name: 'My Passes', href: '/profile', icon: <Ticket size={20} /> },
    ];
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-12">
                    ...
                    <Link to="/" className="flex-shrink-0 flex items-center gap-2 cursor-pointer group hover:rotate-1 transition-transform">
                        ...
                        <span className="font-display font-black text-3xl tracking-tighter text-white group-hover:text-neon-slime transition-colors italic">
                            QRAZY
                        </span>
                    </Link>
