        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-brand-gray/40 font-mono text-sm leading-relaxed mb-8 max-w-sm">
              The future of nightlife access. Secure, verified, and chaotic. Stop screenshots. Start
              partying.
            </p>
          ...
          {}
          <div>
            <h4 className="text-white font-display font-black uppercase mb-6 tracking-tight">
              Marketplace
            </h4>
            <ul className="space-y-4 font-mono text-sm text-brand-gray/40">
              <li>
                <Link to="/clubs" className="hover:text-neon-slime transition-colors">
                  All Clubs
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/profile" className="hover:text-neon-slime transition-colors">
                  My Passes
                </Link>
              </li>
            </ul>
