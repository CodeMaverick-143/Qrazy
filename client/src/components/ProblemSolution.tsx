      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 max-w-2xl mx-auto">
            Traditional ticketing creates operational blind spots. Qrazy provides the visibility and
            control enterprise venues require.
          </p>
        </div>
          ...
          <div className="relative group perspective-1000">
            ...
            <div className="relative h-full p-8 lg:p-10 border border-white/5 bg-corp-bg-lighter rounded-2xl overflow-hidden hover:border-error-red/30 transition-colors duration-300">
              <div className="flex items-center space-x-4 mb-8">
                ...
                <h3 className="text-xl font-bold text-white">Operational Risks</h3>
              </div>
                ...
                {[
                  ...
                  >
                    <XCircle
                      size={20}
                      weight="bold"
                      className="text-error-red mr-3 mt-1 flex-shrink-0 opacity-60 group-hover/item:opacity-100 transition-opacity"
                    />
          ...
          <div className="relative group perspective-1000">
            ...
            <div className="relative h-full p-8 lg:p-10 border border-trust-blue/20 bg-corp-bg-lighter/50 rounded-2xl overflow-hidden shadow-lg hover:border-trust-blue/40 transition-colors duration-300">
              <div className="flex items-center space-x-4 mb-8">
                ...
                <h3 className="text-xl font-bold text-white">The Qrazy Platform</h3>
              </div>
              <ul className="space-y-4">
                {[
                  ...
                  >
                    <CheckCircle
                      size={20}
                      weight="fill"
                      className="text-trust-blue mr-3 mt-1 flex-shrink-0 shadow-sm"
                    />
