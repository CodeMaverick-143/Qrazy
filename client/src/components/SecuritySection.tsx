        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-16 items-center">
          ...
          <div className="mb-12 lg:mb-0">
            ...
            <p className="text-gray-400 text-lg leading-relaxed mb-8">
              We adhere to the strictest compliance standards to ensure your data—and your
            ...
            <div className="mt-10">
              <a
                href="#"
                className="inline-flex items-center text-white font-semibold hover:text-trust-blue transition-colors group"
              >
